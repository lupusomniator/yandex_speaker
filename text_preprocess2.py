...
default_model_path = "russian-syntagrus-ud-2.0-170801.udpipe"
'''
...
class TextPreprocessor:
    ...
    def space_punctuation(self, s: str) -> str:
        return ''.join(c if c not in punctuation or c=='-' else ' %s '%(c) for c in s)
    '''
...
if __name__ == '__main__':
    ...
    print(tp.preprocess_sentence("На Марсе классно - красные пески, крутые горы и кратеры, безумно красивые каналы рядом с экватором. Ничто не сравнится с тамошними закатами. Правда, холодновато и давление, мягко говоря, низковатое."))